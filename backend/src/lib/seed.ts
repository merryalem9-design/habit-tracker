...
const content = [
  // ── Secular quotes ──────────────────────────────────────────────
  { type: "quote" as const, category: "secular_quotes", source: "Viktor Frankl",
    text: "When we are no longer able to change a situation, we are challenged to change ourselves." },
  { type: "quote" as const, category: "secular_quotes", source: "Marcus Aurelius",
    text: "You have power over your mind, not outside events. Realize this and you will find strength." },
  { type: "quote" as const, category: "secular_quotes", source: "Rumi",
    text: "The wound is the place where the light enters you." },
  { type: "quote" as const, category: "secular_quotes", source: "Brené Brown",
    text: "You are imperfect, you are wired for struggle, but you are also worthy of love and belonging." },
  { type: "quote" as const, category: "secular_quotes", source: "Maya Angelou",
    text: "You may encounter many defeats, but you must not be defeated." },
  { type: "quote" as const, category: "secular_quotes", source: "Albert Camus",
    text: "In the middle of winter, I at last discovered that there was in me an invincible summer." },

  // ── Recovery quotes ─────────────────────────────────────────────
  { type: "quote" as const, category: "recovery_quotes", source: "AA Big Book",
    text: "One day at a time. You do not have to do it all at once." },
  { type: "quote" as const, category: "recovery_quotes", source: "Anonymous",
  ...
  // ── Scripture ────────────────────────────────────────────────────
  { type: "verse" as const, category: "scripture", source: "Philippians 4:13",
    text: "I can do all things through Christ who strengthens me." },
  { type: "verse" as const, category: "scripture", source: "Psalm 34:18",
    text: "The Lord is close to the brokenhearted and saves those who are crushed in spirit." },
  { type: "verse" as const, category: "scripture", source: "Isaiah 41:10",
    text: "Do not fear, for I am with you. Do not be dismayed, for I am your God." },
  { type: "verse" as const, category: "scripture", source: "Quran 94:5-6",
    text: "Indeed, with hardship comes ease. Indeed, with hardship comes ease." },
  { type: "verse" as const, category: "scripture", source: "Quran 2:286",
    text: "Allah does not burden a soul beyond that it can bear." },
  { type: "verse" as const, category: "scripture", source: "Proverbs 3:5-6",
    text: "Trust in the Lord with all your heart and lean not on your own understanding." },

  // ── Breathing exercises ──────────────────────────────────────────
  { type: "activity" as const, category: "breathing",
  ...
  // ── Physical activities ──────────────────────────────────────────
  { type: "activity" as const, category: "physical",
    source: null,
  ...
  // ── Journaling prompts ───────────────────────────────────────────
  { type: "activity" as const, category: "journaling",
    source: null,
