...
// either way.
const CRISIS_PATTERNS: { category: string; patterns: RegExp[] }[] = [
  {
...
export function checkContent(content: string): SafetyCheckResult {
  if (!content) return { flagged: false, matchedCategory: null };
