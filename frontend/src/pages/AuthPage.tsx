...
export default function AuthPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-brand-dark px-4">
      ...
      >
        <motion.h1
          className="bg-linear-to-r from-brand-purple to-brand-pink bg-clip-text text-3xl font-bold text-transparent"
          initial={{ scale: 0.8 }}
          animate={{ scale: 1 }}
        ...
        <div className="mt-4 flex flex-col items-center gap-2">
          ...
          {!isSignup && (
            <button
              ...
              className="text-sm text-brand-purple hover:text-brand-pink transition"
            >
              Forgot password?
            </button>
          )}
